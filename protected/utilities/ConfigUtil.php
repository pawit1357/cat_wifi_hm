<?php
class ConfigUtil {
	private static $siteName = 'http://wifi_hm/index.php/Site/LogOut';
	private static $ApplicationTitle = 'WiFi HM | WiFi Hot Spot Management';
...
// 	private static $AppName = '';	
	private static $AppName = '/wifi_hm';
